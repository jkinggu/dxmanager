...
<body>
	<form class="layui-form">
		<input type='hidden' id='salesid' name='salesid'
			value='${sales.salesid }'> <input type='hidden'
			id='customerid' name='customerid' value='${sales.customerid }'>
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<select name="goodsid" id='goodsid' lay-verType='tips'
					lay-verify='goodsid'>
				</select>
			</div>
		</div>
	...
	<script type="text/javascript">
		...
		$('#payeebank').val('${sales.payeebank}');//获取收款账户
	</script>
</body>
</html>
