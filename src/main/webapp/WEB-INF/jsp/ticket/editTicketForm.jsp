...
<body>
	<form class="layui-form">
		<input type='hidden' id='ticketid' name='ticketid'
			value='${ticket.ticketid }'> <input type='hidden' id='usenum'
			name='usenum' value='${ticket.usenum }'>
		<div class="layui-form-item">
			<label class="layui-form-label">登记日期</label>
			<div class="layui-input-block">
				<input name="tickettime" class="layui-input" id="tickettime"
					lay-verType='tips' lay-verify='date' value='${ticket.tickettime }'>
			</div>
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<input name="beginnum" class="layui-input" id='beginnum'
					maxlength="8" lay-verify='number' value='${ticket.beginnum }'
		...
		<div class="layui-form-item">
			<div class="layui-input-block">
				<button class="layui-btn" lay-submit lay-filter="updateTicketForm">提交</button>
